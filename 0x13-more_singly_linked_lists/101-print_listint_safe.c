 ...
 *
 * Return: You shold return if the list is not looped - 0.
 * Otherwise - If not so then the number of unique nodes in the list.
 */
size_t looped_listint_len(const listint_t *head)
{
...
/**
 * print_listint_safe - This actually Prints a listint_t list safely.
